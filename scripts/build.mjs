...
export async function build(){
  ...
  console.log('Built MCR Reference Studio 1.4: maximum-default device graphics controls and optimized 720p demo media. No dependency install required.');return dist;
}
