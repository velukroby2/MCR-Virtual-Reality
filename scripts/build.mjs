...
export async function build(){
  ...
  console.log('Built MCR Reference Studio 1.3: anti-aliased stereo, high-resolution UI text and comfort-focused tracking. No dependency install required.');return dist;
}
