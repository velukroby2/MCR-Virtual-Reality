...
for name in ["index.html", "style.css", "package.json", "render.yaml", "README.md", ".gitignore", "src", "media", "assets", "vendor", "scripts", "tests"]:
    path = root / name
...
with ZipFile(partial) as archive:
    ...
    assert {"render.yaml", "package.json", "index.html", "vendor/three.module.js", "media/Input A.svg", "media/Rescue.svg", "media/Input A.mp4", "media/Input B.mp4", "media/Break.mp4", "media/FOOTAGE.md", "assets/room-reference.jpg", "src/room.js", "vendor/RoundedBoxGeometry.js"}.issubset(archive.namelist())
    for name, data in entries.items():
